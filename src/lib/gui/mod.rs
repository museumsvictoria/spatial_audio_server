...
widget_ids! {
    pub struct Ids {
        ...
        source_editor_selected_soundscape_movement_max_speed_text,
        source_editor_selected_soundscape_movement_max_speed_slider,
        source_editor_selected_soundscape_movement_max_force_text,
        source_editor_selected_soundscape_movement_max_force_slider,
